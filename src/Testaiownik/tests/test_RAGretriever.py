...
class TestRAGRetriever:
    ...
    def test_get_all_chunks_no_text_payload(self, rag_retriever, mock_vector_store):
        ...
        mock_vector_store.client.scroll.return_value = ([mock_point1, mock_point2], None)
    ...
    def test_get_chunk_count_success(self, rag_retriever, mock_vector_store):
        ...
        assert count == 42
        mock_vector_store.client.count.assert_called_once_with(collection_name="test_collection")
